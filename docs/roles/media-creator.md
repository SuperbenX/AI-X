...
### 🎯 1. 
**🎯 实战 Prompt 迷你卡片**  
以下是 3 个高效且场景化的 Prompt 示例，直接复制即可使用：  

| 场景 | Prompt 示例 | 使用建议 |
|------|-------------|----------|
| 📹 视频脚本生成 | "帮我为[主题]创作一个 60 秒视频脚本，语气要[活泼/专业]，并包含开头吸引钩子、中段核心内容、结尾行动号召" | 适合短视频创作者快速生成结构清晰的脚本 |
| 📝 图文排版优化 | "将以下内容改写为适合社交媒体的图文文案，标题要吸引人，正文分为 3 段，句子简短有力，并加入 2 个表情符号： [你的内容]" | 提高图文的可读性与视觉吸引力 |
| 🎙️ 配音字幕生成 | "根据以下文本生成自然的配音稿，并为每句话生成简洁的字幕文本，字幕不超过 15 个字： [你的文本]" | 节省视频制作中配音与字幕的时间 |
