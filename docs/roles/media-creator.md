...
| 功能 | 使用场景 | 直接可用 Prompt 示例 |
|------|----------|----------------------|
| **视频脚本生成** | 你要发一个新品预告短视频，但时间紧、没有脚本灵感。 | “帮我为【产品/主题】写一个 **30 秒** 短视频脚本，包含 **3 个镜头**、**开场抓人钩子**、**结尾互动问题**，语气 **【风格】**，适配 **【平台】** 的节奏。” |
| **图文排版与标题优化** | 你准备发一篇图文，但标题平淡、排版普通，怕没人点开。 | “将以下内容改写为适合 **【平台】** 的图文文案，生成 **1 个≤16字标题** + **分段正文（3 段）** + **2 条配色/版式建议**。内容：『【粘贴原文】』” |
| **配音与字幕生成** | 你剪好了视频，但缺配音和字幕，不想手动做。 | “把以下文案改写为 **【语种】** 的口语化配音稿，并生成匹配的 **SRT 字幕**（每句 ≤15 字），语速适配 **【平台】** 常见视频节奏。文案：『【粘贴文本】』” |
